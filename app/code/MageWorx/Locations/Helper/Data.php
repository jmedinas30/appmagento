...
class Data extends AbstractHelper
{
    ...
    /**
     * XML config path enable working hours
     */
    const XML_PATH_ENABLE_WORKING_HOURS = 'mageworx_locations/general/enable_working_hours';
     ...
     */
    public function isWorkingHoursEnabled($storeId = 0): bool
    {
        $storeId = $storeId ? $storeId : $this->getStoreId();

        return (bool)$this->scopeConfig->isSetFlag(
            self::XML_PATH_ENABLE_WORKING_HOURS,
