    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $location->setIsActive(LocationInterface::ACTIVE);
                $this->locationRepository->save($location);
                $this->messageManager->addSuccessMessage(__('The store has been enabled.'));
        ...
        $this->messageManager->addErrorMessage(__('We can\'t find a store to enable.'));
        $resultRedirect->setPath('mageworx_locations/*/');
