...
class Locations extends Template
{
        ...
        if ($this->locations === null) {
            ...
            switch ($this->getRequest()->getFullActionName()) {
                ...
                case 'catalog_product_view':
                    ...
                    $filters['skip_radius'] = $this->helper->skipRadiusFilter('catalog_product_view');
                    if ($product) {
                ...
                case 'checkout_index_index':
                default:
                $filters['skip_radius'] = $this->helper->skipRadiusFilter('checkout_index_index');
     ...
     * @return bool
     */
    public function isWorkingHoursEnabled(): bool
    {
        return $this->locationHelper->isWorkingHoursEnabled();
    }
     ...
     * @throws \Magento\Framework\Exception\NoSuchEntityException
     */
    protected function getAvailableLocationsWithSourceCode($location, $sourceCode)
    {
        $availableLocationIds = [];
