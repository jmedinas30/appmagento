...
return [
    'modules' => [
        ...
        'GDW_CustomerPhone' => 1,
        'Improntus_PowerPay' => 1,
        'MageWorx_GeoIP' => 1,
        'MageWorx_GoogleApi' => 1,
        'MageWorx_Info' => 1,
        'MageWorx_Locations' => 1,
        'MageWorx_StoreLocator' => 1,
        'MageWorx_Pickup' => 1,
        'MageWorx_LocationPages' => 1,
        'Mageplaza_Core' => 1,
        ...
        'Sparsh_ProductLabel' => 0,
        'Sparsh_WhatsAppChat' => 1,
        'Temando_ShippingRemover' => 1,
        'Vexsoluciones_Pagoefectivo' => 1
    ]
];
