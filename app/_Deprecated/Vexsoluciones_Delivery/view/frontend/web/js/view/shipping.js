    ...
    return Component.extend({
        ...
        saveNewAddress: function () {
            ...
            if (!this.source.get('params.invalid')) {
                ...
                addressData.custom_attributes.provincia_label = {
                                attribute_code: "provincia_label",
                                value: jQuery(".form-shipping-address select[name='province_id']   option:selected").text()
                            }
               addressData.custom_attributes.distrito_label = {
                                attribute_code: "distrito_label",
                                value: jQuery(".form-shipping-address select[name='city']   option:selected").text()
                            }
