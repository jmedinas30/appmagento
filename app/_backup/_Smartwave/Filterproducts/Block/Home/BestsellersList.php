...
class BestsellersList extends \Magento\Catalog\Block\Product\ListProduct {
    ...
    public function getProducts() {
        ...
        $collection->getSelect()
            ...
            ->where("order.state <> 'canceled' and soi.parent_item_id IS NULL AND soi.product_id IS NOT NULL and year(order.created_at) = '2023' and month(order.created_at) in ('8') ")
