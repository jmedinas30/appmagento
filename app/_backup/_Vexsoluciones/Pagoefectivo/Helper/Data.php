...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function obtener_statusnotificacion($tipopago){
        if($tipopago=="pagoefectivo"){
            $status  = trim( $this->_scopeConfig->getValue('payment/pagoefectivo_pay/order_statusnotificacion') );
        }else{
            $status  = trim( $this->_scopeConfig->getValue('payment/cuotealo_pay/order_statusnotificacion') );
        }
